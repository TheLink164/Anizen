    ...
    <div class="row">
      <div class="col-md-12">
        <div class="pull-right">
          <a href="form_registrar.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Nuevo producto</a>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="pull-right">
          <a href="form_registrarAnime.php" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Nuevo anime</a>
        </div>
      </div>
    </div>
              ...
              if ($cantidad > 0) {
                ...
                for ($x = 0; $x < $cantidad; $x++) {
                  ...
                  <tr>
                    ...
                    <td>
                      <?php print $item['nombre_anime'] ?>
                    </td>
                    <td>
                      <?php print $item['nombre_categoria'] ?>
                    </td>
                    <td>
                    ...
                    <td class="text-center">
                      ...
                      <a href="accionesProducto.php?id=<?php print $item['id'] ?>" class="btn btn-danger btn-sm"><span
