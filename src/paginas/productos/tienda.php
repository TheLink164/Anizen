          ...
          <div class="col-md-3">
            <div class="panel panel-default">
              ...
              <div class="panel-footer">
                <a href="../carrito/carrito.php?id=<?php print $item_producto['id'] ?>" class="btn btn-success btn-block">
                  <span class="glyphicon glyphicon-shopping-cart"></span>
                  <?php print $item_producto['precio'] ?> € Comprar
                </a>
                <a href="producto.php?id=<?php print $item_producto['id'] ?>" class="btn btn-success btn-block">
